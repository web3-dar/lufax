    ...
    <>
      ...
      <div className="container mx-auto p-4">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-[40px] text-gray-800 tracking-[0.77px] text-left leading-[56px]">
            {newsItem.title}
          </h1>
          ...
          <div className="mt-6 bg-white overflow-hidden">
            ...
            <div className="p-6">
              <div className="mt-4 text-[18px] text-[#222] leading-loose">
                {contentParagraphs.map((sentence, index) => (
                  <span key={index}>
                    {sentence}.
                    <br />
                  </span>
